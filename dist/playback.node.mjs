...
import * as tonal$1 from 'tonal';
import tonal__default, {  } from 'tonal';
...
function load(stylePath) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (typeof process === 'undefined') {
            ...
            if (isHTTP) {
                // @ts-ignore
                const http = yield import(stylePath.startsWith('https://') ? 'https' : 'http');
...
define$1('in-scale', {
    ...
    const goalScale = tonal__default.Scale.notes(goalTonic, goalScaleName);
...
// @ts-ignore
const tonal = tonal__default || tonal$1;
/**
